...
def load_bits_labels_v2(file_path:Path): #,required_keys:tuple[str]=["name","shape","type"]):
    """
    """
...
def save_bits_labels(file_path:Path, label_data:np.ndarray, label_map:tuple[str]=[]):
    """
...
def sphere_fit_thick_map(mask, refractive_index=1.33, imaging_motor_position=0.0, reference_motor_position=85.0, imaging_range=6, pivot_point=19.2, scan_angle=105,ret_to_rpe:bool=True,micron_output:bool=True,debug:bool=False):
    """
