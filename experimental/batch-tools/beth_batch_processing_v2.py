...
from napari_cool_tools_vol_proc._projection_tools_funcs import projection, ProjectionDir, ProjectionType
...
def generate_enface_with_labels(
    fold_dir: Path = Path(r"E:\_rebatch_conjugate_test_12_01_2025\sample"),
    output_dir: Path = Path(r"E:\_rebatch_conjugate_test_12_01_2025\output"),
    ...
    for _, file_path in tqdm(enumerate(file_paths), desc="Processing OCT Volumes"):
        ...
        if enface_mean_proj:
            ...
            init_enface_data = projection(preproc_data,projection_type=ProjectionType.MEAN.value,axis=ProjectionDir.EN_FACE.value)
        ...
        if enface_max_proj:
            ...
            init_enface_data = projection(preproc_data,projection_type=ProjectionType.MAX.value,axis=ProjectionDir.EN_FACE.value)
        ...
        if show_in_napari:
            if enface_max_proj or enface_mean_proj:
