...
def dc_subtraction_double_sweep(data):
    ...
    corrected_1 = corrected_1 - np.tile(np.median(corrected_1,0),(corrected_1.shape[0],1))
    corrected_2 = corrected_2 - np.tile(np.median(corrected_2,0),(corrected_2.shape[0],1))
