...
def generate_enface_with_labels(fold_dir: Path = Path(r"D:\JJ\Projects\Segmentation_Paper\Data\Bscan"),
    ...
    for _,file_path in tqdm(enumerate(file_paths),desc="Processing OCT Volumes"):
        ...
        init_ridge_labels = enface_onnx_seg_func(init_enface_data,onnx_path=onnx_enface_ridge,segmentation_type="ridge",label_val=4,use_cpu=True,blur=False)
